...
function tran_tb_list() {
    ...
    <div class="wrap">
        ...
        $rows = $wpdb->get_results("SELECT id_tb,  nombreEmpresa , fecha  from $table_name");
        ?>
        <table class='wp-list-table widefat fixed striped posts'>
            ...
            <?php foreach ($rows as $row) { ?>
                <tr>
                    <td class="manage-column ss-list-width"><?php echo $row->id_tb; ?></td>
			        ...
			        <td><a href="<?php echo admin_url('admin.php?page=tran_tb_update&id_tb=' . $row->id_tb); ?>">Update</a></td>
                </tr>
            <?php } ?>
        </table>
    </div>
