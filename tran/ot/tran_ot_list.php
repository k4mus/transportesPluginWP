...
function tran_ot_list() {
    ...
    <div class="wrap">
        ...
        $rows = $wpdb->get_results("SELECT id_ot,  nombreEmpresa , fecha  from $table_name");
        ?>
        <table class='wp-list-table widefat fixed striped posts'>
            ...
            <?php foreach ($rows as $row) { ?>
                <tr>
			        ...
			        <td><a href="<?php echo admin_url('admin.php?page=tran_ot_update&id_ot=' . $row->id_ot); ?>">Update</a></td>
                </tr>
            <?php } ?>
        </table>
    </div>
