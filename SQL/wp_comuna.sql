...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2017 a las 08:06:42
...
--
-- Estructura de tabla para la tabla `wp_comuna`
--

CREATE TABLE `wp_comuna` (
  `ID_COMUNA` int(11) NOT NULL,
  `NAME_COMUNA` varchar(20) DEFAULT NULL,
  `ID_CIUDAD` int(3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

--
-- Volcado de datos para la tabla `wp_comuna`
--

INSERT INTO `wp_comuna` (`ID_COMUNA`, `NAME_COMUNA`, `ID_CIUDAD`) VALUES
(1, 'Iquique', 3),
(2, 'Alto Hospicio', 3),
(3, 'Pozo Almonte', 4),
(4, 'Camiña', 4),
...
--
-- Indices de la tabla `wp_comuna`
--
ALTER TABLE `wp_comuna`
  ADD PRIMARY KEY (`ID_COMUNA`),
  ADD KEY `COMUNA_PROVINCIA_ID` (`ID_CIUDAD`);
...
--
-- AUTO_INCREMENT de la tabla `wp_comuna`
--
ALTER TABLE `wp_comuna`
...
--
-- Filtros para la tabla `wp_comuna`
--
ALTER TABLE `wp_comuna`
  ADD CONSTRAINT `wp_comuna_ibfk_1` FOREIGN KEY (`ID_CIUDAD`) REFERENCES `wp_ciudad` (`ID_CIUDAD`) ON UPDATE CASCADE;
